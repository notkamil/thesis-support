#ifndef OTTERBRIX_CAPI_H
#define OTTERBRIX_CAPI_H
...
cursor_ptr create_collection(otterbrix_ptr ptr,
                             string_view_t database_name,
                             string_view_t collection_name);
cursor_ptr drop_database(otterbrix_ptr ptr, string_view_t database_name);
cursor_ptr drop_collection(otterbrix_ptr ptr,
                           string_view_t database_name,
                           string_view_t collection_name);
...
value_ptr cursor_get_value_by_name(cursor_ptr ptr,
                                   int32_t row_index,
                                   string_view_t column_name);
